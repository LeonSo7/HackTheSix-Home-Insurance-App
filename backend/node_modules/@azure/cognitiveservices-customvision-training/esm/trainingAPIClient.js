...
var TrainingAPIClient = /** @class */ (function (_super) {
    tslib_1.__extends(TrainingAPIClient, _super);
    /**
...
var createImageTagsOperationSpec = {
    ...
    requestBody: {
        parameterPath: "batch",
        mapper: tslib_1.__assign({}, Mappers.ImageTagCreateBatch, { required: true })
    },
    responses: {
        200: {
...
var createImageRegionsOperationSpec = {
    ...
    requestBody: {
        parameterPath: "batch",
        mapper: tslib_1.__assign({}, Mappers.ImageRegionCreateBatch, { required: true })
    },
    responses: {
        200: {
...
var createImagesFromFilesOperationSpec = {
    ...
    requestBody: {
        parameterPath: "batch",
        mapper: tslib_1.__assign({}, Mappers.ImageFileCreateBatch, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.ImageCreateSummary
...
var createImagesFromUrlsOperationSpec = {
    ...
    requestBody: {
        parameterPath: "batch",
        mapper: tslib_1.__assign({}, Mappers.ImageUrlCreateBatch, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.ImageCreateSummary
...
var createImagesFromPredictionsOperationSpec = {
    ...
    requestBody: {
        parameterPath: "batch",
        mapper: tslib_1.__assign({}, Mappers.ImageIdCreateBatch, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.ImageCreateSummary
...
var queryPredictionsOperationSpec = {
    ...
    requestBody: {
        parameterPath: "query",
        mapper: tslib_1.__assign({}, Mappers.PredictionQueryToken, { required: true })
    },
    responses: {
        200: {
...
var updateIterationOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.Iteration, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.Iteration
...
var updateTagOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.Tag, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.Tag
